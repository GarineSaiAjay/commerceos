...
- **A real external protocol surface.** An MCP server exposes the same commerce tools to any MCP-compatible client (Claude Desktop, the MCP Inspector) — this isn't a bespoke API only the demo frontend can talk to.
